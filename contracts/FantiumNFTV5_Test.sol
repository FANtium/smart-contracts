    ...
    IFantiumNFT
{
    ...
    function addCollection(
        ...
        require(
            ...
            "FantiumNFTV5: max invocations must be less than 10,000"
        );
        require(
            _athletePrimarySalesBPS <= 10_000,
            "FantiumNFTV5: athletePrimarySalesBPS must be less than 10,000"
        );
        require(
            nextCollectionId < 1_000_000,
            "FantiumNFTV5: max collections reached"
        );
        require(
    ...
    function updateCollectionAthleteAddress(
        ...
        require(
            ...
            "FantiumNFTV5: address cannot be 0"
        );
