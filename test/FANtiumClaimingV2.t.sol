...
//    }
    ...
    function test_computeShares_ok_success() public {
        ...
        uint256 expectedTournamentDistributionAmount = invocationNumber * tournamentEarningsShare1e7 * totalTournamentEarnings / 1e7;
        uint256 expectedOtherDistributionAmount = invocationNumber * otherEarningShare1e7 * totalOtherEarnings / 1e7;

        assertEq(fantiumClaiming.distributions(distEventId).tournamentDistributionAmount, expectedTournamentDistributionAmount);
