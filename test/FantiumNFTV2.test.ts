...
import { FantiumV2 } from '../typechain-types'

describe("FANtiumNFTV2", () => {
    ...
    it("checks that we can deploy upgrade", async () => {
        const fanV2 = await ethers.getContractFactory("FantiumV2")
        const nftContractV2 = await upgrades.upgradeProxy(nftContract.address, fanV2) as FantiumV2
