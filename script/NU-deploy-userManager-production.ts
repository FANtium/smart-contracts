...
async function main() {
  ...
  const userManagerContract = await upgrades.deployProxy(FantiumUserManager, [deployer.address,'0x0020b7d87a663F7c113f85230f084856EE79033B','0x3De3D4eaC11c6468140Ffd661C009D52c4956F55','0xBf175FCC7086b4f9bd59d5EAE8eA67b8f940DE0d'], { initializer: 'initialize', kind: 'uups'})
