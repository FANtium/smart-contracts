...
async function main() {
  ...
  const claimingContract = await upgrades.deployProxy(FantiumClaiming, [deployer.address,'0xE09A37dF3fB8017F5f50dbF43FBEa619c5b9532f','0x0020b7d87a663F7c113f85230f084856EE79033B','0xBf175FCC7086b4f9bd59d5EAE8eA67b8f940DE0d'],{ initializer: 'initialize', kind: 'uups'})
