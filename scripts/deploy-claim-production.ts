...
async function main() {
  ...
  const claimingContract = await upgrades.deployProxy(FantiumClaiming, [defaultAdminAddress,payOutToken,fantiumNFTContract,trustedForwarder],{ initializer: 'initialize', kind: 'uups'})
