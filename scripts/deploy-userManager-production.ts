...
async function main() {
  ...
  const userManagerContract = await upgrades.deployProxy(FantiumUserManager, [defaultAdminAddress,nftContractAddress,claimingContract,forwarder], { initializer: 'initialize', kind: 'uups'})
