...
async function main() {
  ...
  const userManagerContract = await upgrades.deployProxy(FantiumUserManager, [defaultAdminAddress,nftContractAddress,nftContractAddress], { initializer: 'initialize', kind: 'uups'})
